define('app/views/common/header', [
    ...
    var s = e('magix'),
        ...
        u = e('app/i18n/index'),
        d = [
            { path: '/home/index', text: u.NAV_INDEX },
            /*{ path: '/illustrations/index', text: u.NAV_ILLUSTRATION },
            {
                path: '/collections/index',
                text: u.NAV_COLLECTION,
                subMenu: [
                    { url: '/collections/index?type=1', title: u.NAV_OFFCIAL_COLLECTION },
                    { url: '/collections/index?type=2', title: u.NAV_COLOR_COLLECTION },
                    { url: '/collections/index?type=4', title: u.NAV_SINGLE_COLLECTION },
                    { url: '/collections/index?type=3', title: u.NAV_ALL_COLLECTION },
                ],
            },*/
            {
                path: '/manage/index',
                ...
                login: !0,
                subMenu: [
                    { url: '/manage/index?manage_type=myicons', title: u.NAV_MY_ICONS },
                    { url: '/manage/index?manage_type=mylikes', title: u.NAV_MY_LIKES },
                    /*{
            ...
            /*{
                ...
                text: u.NAV_HELP,
                subMenu: [
                    { url: '/help/detail?helptype=about', title: u.HELP_FUNCTION_INR },
                    { url: '/help/detail?helptype=draw', title: u.HELP_ICON_DRAW },
                    { url: '/help/detail?helptype=code', title: u.HELP_CODE_APPLY },
                    { url: '/help/detail?helptype=article', title: u.HELP_ABOUT_ARTS },
                    { url: '/help/index', title: u.HELP_ABOUT },
                ],
            },*/
            /*{ path: '/activity/lists', text: u.NAV_ACTIVITY },*/
        ]
    i.exports = s.View.extend({
        tmpl: '<header><div class="site-nav clearfix wrap"><div class="logo"><a href="/" data-spm-click="gostr=/alimama.30;locaid=d4d0a486a"></a></div><nav><ul class="clearfix">{{#for(menu in menuList)}}<li class="nav-item" t-class:current="menu.current"><a class="nav-item-link" href="{{menu.path}}" data-login="{{menu.login}}" vclick-ignore="true" target="{{menu.blank ? \'_blank\' : \'\'}}">{{menu.text}}</a> {{#if(menu.subMenu)}}<ul class="head-dropdown">{{#for(sub in menu.subMenu)}}<li><a href="{{sub.url}}" data-login="{{menu.login}}" vclick-ignore="true">{{sub.title}}</a></li>{{/for}}</ul>{{/if}}</li>{{/for}}</ul></nav><div class="quick-menu"><ul class="clearfix"><li class="head-search"><div class="form_search search-box"><div class="dropdown-search" mx-change="setFilter()" mx-view="app/exts/dropdown/index" mx-options="{searchbox: 0, selected:\'{{searchType}}\', list:\'{{dropdown}}\'}"></div><input type="text" class="s_input input_enter_placeholder" placeholder="**NAV_SEARCH_PLACE_HOLDER**" value="{{query}}" id="J_suggest_input" autocomplete="off"> <span class="input_enter_icon iconfont" mx-click="search()" data-spm-click="gostr=/alimama.30;locaid=d81551fea">&#xe645;</span><div id="J_suggest_box" mx-options="{target:\'J_suggest_input\'}" class="suggest-box" mx-view="app/exts/suggest/index" mx-changevalue="suggest()"></div></div></li><li>{{#unless(user.id)}} <a href="javascript:;" mx-click="login()" data-spm-click="gostr=/alimama.30;locaid=dc68fa794" class="signin"><i class="iconfont">&#xe637;</i> </a>{{/unless}} {{#if(user.id)}}<div class="cp"><span class="avatar avatar-min"><img src="{{user.avatar|adaptImg100}}"></span></div><ul class="head-dropdown"><li><a href="/user/center" data-spm-click="gostr=/alimama.30;locaid=de91a75a0" vclick-ignore="true">**NAV_SETTING**</a></li><li><a href="/api/logout" data-spm-click="gostr=/alimama.30;locaid=ded9b439d" vclick-ignore="true">**NAV_LOGOUT**</a></li></ul>{{/if}}</li><li><a vclick-ignore="true" href="/icons/upload" data-spm-click="gostr=/alimama.30;locaid=d059fa781" class="upload"><i class="iconfont">&#xe640;</i></a></li><li>{{^if(language === \'en-US\' || language === \'en-us\')}} <span class="lang-btn iconfont" mx-click="changeLanguage(\'en-us\')" data-spm-click="gostr=/alimama.30;locaid=db1b1e3c3">&#xe641;</span> {{/if}} {{#if(language === \'en-US\' || language === \'en-us\')}} <span class="lang-btn iconfont" mx-click="changeLanguage(\'zh-cn\')" data-spm-click="gostr=/alimama.30;locaid=d2260e3a2">&#xe63f;</span> {{/if}}</li><li mx-click="toggleCar()" data-spm-click="gostr=/alimama.30;locaid=d8f68128f"><span class="icon-car"><i class="iconfont">&#xe63c;</i> <span id="J_icon_car_count" class="icon-car-count">{{*iconsCount}}</span></span></li></ul></div></div></header>',
            ...
            '/help/index' === i
                ...
                (e.data = {
                    ...
                    dropdown: JSON.stringify([
                        { name: u.SEARCH_SELECT_ICON, id: 'icon', type: 'icon' },
                        {
                            name: u.SEARCH_SELECT_ILLUSTRATION,
                            id: 'illustration',
                            type: 'illustration',
                        },
                        { name: u.SEARCH_SELECT_USER, id: 'user', type: 'user' },
                    ]),
                }),
        ...
        wrapMenu: function(e, i) {
            return (
                c.each(e, function(e, a) {; - 1 !== a.path.indexOf(i) ? (a.current = !0) : (a.current = !1)
                }),
                e
            )
        },
        ...
        'suggest<changeValue>': function(e) {
            ...
            this.wrapModel(t).getSuggest({ q: e, type: a }, function(e) {;
        ...
        'setFilter<change>': function(e) {
            ...
            s.config({ searchType: e }),
                'icon' === e ?
                s.Router.to({ searchType: e }) :
