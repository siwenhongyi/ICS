!(function (n, t, r, i, a, o, e, c, u, f, s, l, m, h, v) {
	...
	!(function (n) {
		...
		function p() {
			var n = y.outerWidth
			return (
				null == n && (n = u.documentElement.clientWidth || u.body.clientWidth),
				n
			)
		}
		function d() {
			...
			return (
				null == n &&
					(n = u.documentElement.clientHeight || u.body.clientHeight),
				n
			)
		}
		n.a = t
	...
	!(function (n) {
		...
		function j() {
			...
			if (n)
				try {
					var t = new n({ frequency: 2 })
					return (
						(t.onreading = function () {
							fn = t.z
						}),
						void t.start()
					)
		...
		function A() {
			if (
				('ontouchmove' in u &&
					(p.i(u, 'touchmove', v, !0), p.i(u, 'touchstart', a, !0)),
				p.i(u, 'mousemove', m, !0),
				p.i(u, 'mousedown', r, !0),
				p.i(u, 'click', e, !0),
				p.i(u, 'keydown', g, !0),
		...
		function B() {
			...
			return (D = undefined), (N = undefined), { K: n, L: t, M: r }
		}
		function L() {
			return [an, on]
		}
		...
		;(/dingtalk|youku|uczzd\.cn|sm\.cn|uc\.cn/.test(l.hostname) ||
			/iPhone|iPad|Qianniu|DingTalk|Youku|SQREADER/.test(_)) &&
			(un = !1)
		var fn = null,
			sn = [],
			ln = 0
	...
	!(function (n) {
		...
		function v(n) {
			...
			var i = p.e(n, '?')
			return h(i, y.__sufei_point_list)
				? (m(n, 0), !1)
				: !t(r, E.ha) &&
						!(r in E.ga) &&
						!/\/gw-open\/|\/gw\/|ascp\.alibaba\.com/.test(i) &&
						!h(i, y.__sufei_ignore_list) &&
						(m(n, 0), !1)
		}
		function d(n) {
			var r = u.referrer
	...
	!(function (n) {
		...
		function r() {
			...
			var t = n.prototype,
				r = /^src$/i
			return (
				T.ja(t, 'setAttribute', function (n) {
					var t = n[0],
						i = n[1]
					r.test(t) && o(i)
				}),
	...
	!(function (n) {
		...
		function e() {
			...
			n &&
				T.ja(n.prototype, 'submit', function (n, t) {
					var r = t
		...
		function r() {
			T.ja(y, 'fetch', function (n) {
				...
				'string' == typeof t &&
					S.va(t) &&
					((r = r || {}),
					(r.credentials && 'omit' !== r.credentials) ||
