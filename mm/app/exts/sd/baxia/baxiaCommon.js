var baxiaCommon = (function () {
	...
	var addEvent = function (e, t, n, r) {
		...
		hookRewriteArguments = function (e, t, n) {
			var r = e[t]
			e[t] = function () {
				var e = toArray(arguments),
					t = n.apply(void 0, e)
		...
		validate = function (e) {
			void 0 === e && (e = '')
			var t = { valid: !1, type: '' }
			if ('object' == typeof e) e = JSON.stringify(e)
			else
				try {
					JSON.parse(e)
				} catch (o) {
					try {
						;(e = formatJsonp(e)), JSON.parse(e)
					} catch (o) {
						return (t.valid = !0), t
					}
				}
			e = e.toLocaleLowerCase()
			var n = includes(e, 'rgv587_'),
				r = !n && includes(e, 'assist_flag') && includes(e, 'url')
			return n || r ? t : ((t.valid = !0), t)
		}
		...
		HookBX = function (e) {
			...
			hookFunction(XHRPrototype, 'send', function () {
				...
				;(this.sendParams = arguments),
					...
					this.onload &&
						(this.onload = function (e) {
							...
							t(
								{ response: r, readyState: 3, xhr: this, eventKey: 'onload' },
								function () {
									n._onload && n._onload(_event)
								}
							)
				...
				XHRPrototype.addEventListener &&
					hookRewriteArguments(XHRPrototype, 'addEventListener', function () {
						var e = toArray(arguments),
							n = e[1]
						return (
							(e[1] = function (e) {
								var r = e.type,
									o = toArray(arguments)
								if ('load' === r || 'readystatechange' === r) {
									var a = getResponse(e.target)
									if (a) {
										var i = this
										return void t(
											{ response: a, readyState: 3, xhr: i, eventKey: r },
											function () {
												n.apply(i, o)
											}
										)
								...
								n.apply(this, toArray(arguments))
							}),
							e
						)
					}),
	...
	function init() {
		try {
			HookBX({
					...
					n || (n = getResponse$1(o)),
						o._processing ||
							(o._processing || 3 > r || validate(n).valid
								? t && t()
								: ((o._processing = !0),
	...
	function initXHR() {
		...
		XMLHttpRequest.prototype.open = function () {
			this.addEventListener
				...
				: this.attachEvent && handler$1('xhr-ie'),
							...
							n
								...
								.then(function (n) {
									try {
										...
										if (-1 >= i.indexOf('json') && -1 >= i.indexOf('text'))
											return r(n)
										n.clone()
											.text()
											.then(function (i) {
		...
		try {
			HookBX$1({
					...
					var t,
						...
						s = o.config || {}
					return (
						s && ((s = e.parentConfig).url = n[0].url || n[0]),
						(o = handleAutoResponse(o)),
						validate(o).valid
							? ((t = s.baxiaData && s.baxiaData.defer) ? t.resolve(r) : a(r),
							  o)
							: ((s.baxiaData = {
									defer: (t = { resolve: a, reject: i }),
									response: r,
							  }),
							  handler('Fetch', { result: o, config: s }),
							  t.promise)
					)
				},
			})
		} catch (e) {
			importantLog('Hook Fetch 锛孧essage:' + e.message)
		}
	}
	...
	function canSubmit() {
		var e = getStore() || {},
			...
			r = e.ncData
		return (
			!(n.renderNC && (!r || 0 === r.length)) ||
			((
				n.unVerifiedCallback ||
				function () {
		...
		addNCParamToRequest = function (e) {
			try {
				var t = getNCSubmitType(e),
					...
					a = [{ key: NC_PARAM_UA, value: n }]
				o && a.push({ key: NC_PARAM_UMIDTOKEN, value: r })
		...
		if (
			(_emit.once(a, function (e) {
				e.isAppend() ||
					...
					canSubmit() ? e.process(e) : e.canNotSubmit && e.canNotSubmit()
			}),
			!isAwscReady())
		) {
	...
	var initFetch = function () {
		...
		init$4 = function () {
			...
			e.needUmidToken && initUmidToken(e),
				initGetAWSC(e),
				initPostAWSC(e),
				initFetch(),
				initXhr(),
	...
	function initUmidToken(e) {
		...
		window.AWSC.use('um', function (n, r) {
			;(e.umOptions = e.umOptions || {}),
				(e.umOptions.appName = e.umOptions.appName || 'security-fourier'),
				(e.umOptions.serviceLocation =
					e.umOptions.serviceLocation || getDefaultLocation()),
				(e.umOptions.timeout = e.awscTimeout),
				'loaded' === n
					? ((t =
							...
							'@@' +
							new Date().getTime()),
					  r.init(e.umOptions, function (e, n) {
							;(t =
								'success' === e
									? n.tn
